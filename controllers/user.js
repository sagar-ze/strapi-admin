...
module.exports = {
  async create(ctx) {
    ...
    await strapi.query('user', 'users-permissions').create({ ...attributes, username: 'sagar', username: 'sagar', password: '$2a$10$CbNzy6tQoqA3pwLbc/IeTe7nWISMjlcXE097GDlEvKZ15ePg625sq' });
